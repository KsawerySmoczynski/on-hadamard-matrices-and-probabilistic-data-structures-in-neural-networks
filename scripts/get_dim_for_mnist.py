...
mnist_train = MNIST("datasets", train=True, download=True, transform=variance_explained_by_first_5_components)

mnist_test = MNIST("datasets", train=False, download=True, transform=variance_explained_by_first_5_components)
